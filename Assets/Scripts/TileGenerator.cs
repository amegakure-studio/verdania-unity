...
namespace Amegakure.Verdania.GridSystem
{
    public class TileGenerator : MonoBehaviour
    {
        ...
        Vector2 DetermineTileSize(Bounds tileBounds, float scaleFactor)
        {
            ...
            return new Vector2((tileBounds.extents.x * 2) * scaleFactor, (tileBounds.extents.z * 2) * scaleFactor);
        }
        ...
        public void GenerateGrid(GameObject tile, Vector2Int gridsize)
        {
            ...
            Vector2 tileSize = DetermineTileSize(tile.GetComponent<MeshFilter>().sharedMesh.bounds, tile.transform.localScale.x);
